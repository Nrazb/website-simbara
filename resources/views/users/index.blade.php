...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const deleteModal = document.getElementById('delete-user');
        ...
        document.querySelectorAll('button[data-modal-target="delete-user"]').forEach(button => {
