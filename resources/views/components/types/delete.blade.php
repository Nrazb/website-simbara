<template x-if="selectedId">
    <div id="delete-modal-type" x-show="selectedId"
        ...
        <div class="bg-white w-[90%] sm:w-[80%] md:w-full max-w-md rounded-xl shadow-lg p-6 relative"
            ...
            <h2 class="text-lg font-semibold text-gray-900 mb-4 text-center">Hapus Jenis Barang</h2>
            ...
            <form id="deleteForm" method="POST" x-bind:action="'/types/' + selectedId">
                @csrf
                @method('DELETE')
