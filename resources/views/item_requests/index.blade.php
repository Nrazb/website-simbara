        ...
        <div class="p-3 sm:p-6 bg-white rounded-2xl shadow-sm">
            <div class="flex flex-wrap items-center justify-between gap-4 mb-5">
                <form method="GET" class="relative w-full sm:max-w-xs">
                    <input type="text" name="search" placeholder="Cari usulan barang" value="{{ request('search') }}"
            ...
            <div class="mb-4 rounded-xl shadow-sm">
                <form method="GET" class="flex flex-wrap items-center gap-4">
                    ...
                    @if (request()->anyFilled(['user_id', 'year', 'status']))
                            ...
                            <tr class="hover:bg-gray-50 transition {{ $data->trashed() ? 'text-red-600' : '' }}"
                                ...
                                <td class="px-4 py-3 text-center">
                                    ...
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        @if ($data->isDraft())
                                        <button class="border border-amber-500 hover:bg-amber-500 text-amber-500 hover:text-white p-2 rounded-lg"
                                        ...
                                        @if ($data->isDraft())
                                        <button class="border border-red-500 hover:bg-red-500 text-red-500 hover:text-white p-2 rounded-lg"
                                ...
                                <td class="px-4 py-3">
                                    @if ($data->isDraft())
                                        <span class="px-2 py-1 bg-yellow-100 text-yellow-700 text-xs rounded-lg">Draft</span>
                                    @else
                                        <span class="px-2 py-1 bg-green-100 text-green-700 text-xs rounded-lg">Terkirim</span>
                                    @endif
                                </td>
                ...
                @forelse ($itemRequests as $data)
                    <div class="border border-gray-200 rounded-xl p-3 shadow-sm {{ $data->trashed() ? 'text-red-600' : '' }}"
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <p>
                                @if ($data->isDraft())
                                <span class="px-2 py-1 bg-yellow-100 text-yellow-700 text-medium rounded-lg">Draft</span>
                                @else
                                    <span class="px-2 py-1 bg-green-100 text-green-700 text-medium rounded-lg">Terkirim</span>
                                @endif
                            </p>
                        </div>
